...
{
    const string privateCode = "3zYvSSFmXE28l9-JueXhHwbi1vtySSYEGjVJvrpHUEpA";  //Key to Upload New Info
    const string publicCode = "6429b7a18f40bb109c02efea";   //Key to download
    ...
    IEnumerator DatabaseDownload()
    {
        ...
        UnityWebRequest www = UnityWebRequest.Get(webURL + publicCode + "/pipe/0/10"); //Gets top 10
        yield return www.SendWebRequest();
